    ...
    >
      ...
      <template v-slot:[`item.status`]="{ item }">
        <div v-if="item.status == 1">
          <v-chip small color="success">{{ text_active }}</v-chip>
        </div>
        <div v-else-if="item.status == 2">
          <v-chip small color="warning">{{ text_suspended }}</v-chip>
        </div>
        <div v-else-if="item.status == 3">
          <v-chip dark small color="black">{{ text_expired }}</v-chip>
        </div>
        <div v-else-if="item.status == 4">
          <v-chip small color="secondary">{{ text_delete }}</v-chip>
        </div>
